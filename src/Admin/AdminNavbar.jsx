    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + isLargeScreen, backgroundColor: 'rgb(255, 255, 255)' }}>
        <Toolbar>
          ...
          {/* <Avatar alt="Zosh" src="https://play-lh.googleusercontent.com/uBtIni47_jr5xXD_USHSk8BDUw42Jxp0fptgqYPDaAZRaDui0ZZmuxexlZkiulPFCqM=w240-h480-rw" /> */}
          <div className="ml- flex lg:ml-0  ">
              
              <span className="sr-only">Your Company</span>
              <img 
                src="https://play-lh.googleusercontent.com/uBtIni47_jr5xXD_USHSk8BDUw42Jxp0fptgqYPDaAZRaDui0ZZmuxexlZkiulPFCqM=w240-h480-rw"
                alt="Shopwithmyshop"
