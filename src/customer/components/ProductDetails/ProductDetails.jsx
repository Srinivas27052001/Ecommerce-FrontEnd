...
<div className="flex flex-col items-center">
          ...
          <div className="flex  flex-wrap space-x-5 justify-content">
        ...
        {/* Product info */}
        <div className='lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-6 lg:pb-24'>
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className='opacity-50 text-sm'>565656 Ratings</p>
            <p className='mi text-sm font-medium text-indigo-600 hover:text-indigo-500'> 3333 Reviews</p>
            ...
            <Grid item xs={5} >
             <h1 className='text-xl font-semibold pb-2'>Product Ratings</h1>
              ...
              <div className='flex  items-center space-x-3'>
               ...
               <p className='opacity-60 '>567788 Ratings</p>
